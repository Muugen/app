...
class AdminVoitureModel extends Driver{
    ...
    public function updateVoiture(Voiture $updateV){
        ...
        if($updateV->getImage() === ""){
            $sql = "UPDATE voiture
                SET marque = :marque, modele = :modele, prix = :prix, annee = :annee, quantite = :quantite, description = :description, id_cat = :id_cat WHERE id_v = :id_v";
            ...
            $sql = "UPDATE voiture
                SET marque = :marque, modele = :modele, prix = :prix, annee = :annee, quantite = :quantite, image = :image, description = :description, id_cat = :id_cat WHERE id_v = :id_v";
